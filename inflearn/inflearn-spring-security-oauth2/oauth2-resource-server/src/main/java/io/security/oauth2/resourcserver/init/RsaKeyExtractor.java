package io.security.oauth2.resourcserver.init;
...
public class RsaKeyExtractor implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        String path = "C:\\study\\inflearn\\inflearn-spring-security-oauth2\\oauth2-resource-server\\src\\main\\resources\\certs\\";
