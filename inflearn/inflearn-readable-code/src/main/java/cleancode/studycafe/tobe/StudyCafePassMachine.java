...
import cleancode.studycafe.tobe.provicer.LockerPassProvider;
import cleancode.studycafe.tobe.provicer.SeatPassProvider;
...
public class StudyCafePassMachine {
    ...
    private StudyCafeSeatPass selectPass() {
        ...
        List<StudyCafeSeatPass> passCandidate = findPassCandidatesBy(studyCafePassType);
        return ioHandler.getSelectPass(passCandidate);
    }
