...
class UserServiceTest @Autowired constructor(
    ...
    fun getUserLoanHistoriesTest2() {
        ...
        assertThat(results[0].books).extracting("isReturn").containsExactlyInAnyOrder(false, true, false)
    }

    @Test
    @DisplayName("위의 대출 기록 테스트 2개를 합친 테스트")
    fun getUserLoanHistoriesTest3() {
        ...
        assertThat(userAResult.books).extracting("isReturn").containsExactlyInAnyOrder(false, true, false)
